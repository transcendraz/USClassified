...
public class ViewUserWishlistActivity  extends AppCompatActivity {
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.buy_item:
                            intent = new Intent(ViewUserWishlistActivity.this, ExploreActivity.class);
                            startActivity(intent);
                            break;
                        case R.id.user_profile_item:
                            intent = new Intent(ViewUserWishlistActivity.this, ViewUserProfileActivity.class);
                            startActivity(intent);
                            return true;
                        case R.id.sell_item:
                            intent = new Intent(ViewUserWishlistActivity.this, CreateItemPostActivity.class);
                            startActivity(intent);
                            break;
                    }
                    return false;
...
//        recAdapter = new FriendsAdapter(fList);
        ...
        String baseUrl = "http://167.172.197.162/api/v1/users/"+new Integer(CurruserId).toString()+"/wishlist";
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < itemsId.length(); ++i) {
                        ...
                        JSONObject b=itemsId.getJSONObject(i);
                        int c=b.getInt("id");
                        requestItemNameJsonObject(c, lastEl);
                    }
                    ...
                    if (last) {
                        ...
                        recAdapter.setOnItemClickListener(new ItemsAdapter.OnItemClickListener() {
                            ...
                            public void onItemClick(int position) {
                                ...
                                Intent intent = new Intent(ViewUserWishlistActivity.this, ItemActivity.class);
